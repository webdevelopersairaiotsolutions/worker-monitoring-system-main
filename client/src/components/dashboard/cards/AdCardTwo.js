...
function AdCardTwo() {
  return (
    <div>
      <>
  import React, {"{"} useState, useEffect {"}"} from "react"; import ChartFour
  from "../charts/ChartFour"; import Navbar from "../../Navbar"; import Sidebar
  from "../../Sidebar"; const Statistics = () =&gt; {"{"}
  // Dummy statistic data return (
